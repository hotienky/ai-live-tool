...
const CurrencyInput = window.__APP_BRIDGE__?.components?.CurrencyInput
const LanguageTabs = window.__APP_BRIDGE__?.components?.LanguageTabs
const MediaPicker = window.__APP_BRIDGE__?.components?.MediaPicker
import { useI18n } from '../helpers.js'
import { useContentTranslations } from '../helpers.js'
import { useLanguages } from '../helpers.js'
