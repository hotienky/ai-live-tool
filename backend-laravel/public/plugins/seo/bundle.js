/**
 * Auto-generated stub bundle for module: seo
...
(function() {
  ...
  hooks.addFilter('sidebar_items', function(items) {
    items.push({key:'system/seo',label:'SEO',icon:'Search',featureGroup:'store',moduleId:'seo'});
    return items;
  });

  // Register admin routes
  hooks.addFilter('admin_routes', function(config) {
    Object.assign(config.routeToTab, {'system/seo':'seo-settings'});
    return config;
  });
  ...
  var plugin = {
    ...
    version: '1.0.0',
    sidebar: {"group":"Hệ thống","items":[{"key":"seo-settings","label":"SEO","icon":"Search","route":"system\/seo"}]}
  };
