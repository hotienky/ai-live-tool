...
return new class extends Migration {
    public function up(): void
    {
        ...
        Schema::create('shipments', function (Blueprint $table) {
            ...
            $table->string('carrier', 30)->default('manual'); // manual|ghn|ghtk|viettel_post
            ...
            // draft|pending|picked_up|in_transit|out_for_delivery|delivered|returned|cancelled
        ...
        Schema::create('shipment_history', function (Blueprint $table) {
            ...
            $table->string('source', 30)->default('admin'); // admin|carrier|system
